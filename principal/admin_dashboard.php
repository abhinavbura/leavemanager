			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4 user-icon">
						<img src="../vendors/images/onee.jpg" alt="">
					</div>
					<div class="col-md-8">
						...
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back<br>Mr.</br> <div class="weight-600 font-30 text-blue"><?php echo $row['FirstName']. " " .$row['LastName']; ?>,</div>
						</h4>
						<p class="font-18 max-width-600">Principal, MRCET Campus.</p>
					</div>
				</div>
			</div>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											...
											<?php if($stats==0)
											{ ?>
											<a class="dropdown-item" href="accept.php?leaveid=<?php echo $row['lid'];?>&tracker=1"><i class="dw dw-eye"></i>Accept</a>
											<a class="dropdown-item" href="accept.php?leaveid=<?php echo $row['lid'];?>&tracker=2"><i class="dw dw-eye"></i>decline</a> <?php } ?>
										</div>
									</div>
								</td>
							</tr>
