...
<?php
	...
	{ 
		...
		elseif ($status === '1') {
			if($leave_type==="CCL")
			{
				$result = mysqli_query($conn,"update tblleaves, tblemployees set tblleaves.AdminRemark='$description',tblleaves.Status='$status',tblleaves.AdminRemarkDate='$admremarkdate', tblleaves.registra_remarks = '$cclremark', tblleaves.admin_status = '$cclstatus' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
			}
			else
			{
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" name="leave_type" readonly value="<?php echo htmlentities($result->LeaveType);?>">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
						...
						<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											...
											<input name="hourclass" type="text" class="form-control" required="true" autocomplete="off" readonly value="<?php echo htmlentities($result->class_hour);?>">
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label>Substute Staff Name</label>
											<input name="substute" type="text" class="form-control" required="true" autocomplete="off" readonly value="<?php echo htmlentities($result->substute);?>">
										</div>
									</div>
								</div>
						...
						<div class="form-group row">
						<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Leave Reason</b></label>
						<img src="<?php echo (!empty($result->location) ? '../uploads/'.$result->location : '../uploads/noimage.png'); ?>" alt="" class="avatar-photo">
						</div>
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
