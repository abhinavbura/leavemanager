...
<?php
	...
	{ 
		...
		$quer=mysqli_query($conn,"select empid from tblleaves where id=$did");
		if($quer->rowCount() > 0)
	{
	foreach($quer as $aaa)
{
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="leavetype" class="selectpicker form-control" data-style="btn-outline-info" readonly value="<?php echo htmlentities($result->LeaveType);?>">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
