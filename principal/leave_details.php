...
{ 
	...
	$res=mysqli_query($conn,"select empid from tblleaves where id='$did'")  or die(mysqli_error());
...
$blql = "SELECT $levtyp from tblemployees where emp_id='$empid'";
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="selectpicker form-control"  data-style="btn-outline-info" readonly name="leavetype" value="<?php echo htmlentities($result->LeaveType);?>">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
