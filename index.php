...
<body class="login-page">
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo"><link rel="images-removebg-preview" sizes="180x180px" href="vendors/images/images-removebg-preview.png">
				<a href="login.html">
					<img src="vendors/images/mrcet-removebg-preview.png" alt="">
				</a>
			</div>
		</div>
	</div>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Login To MRCET</h2>
						</div>
