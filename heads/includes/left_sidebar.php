<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.php">
				<img src="../vendors/mrcet-removebg-preview.png" alt="" class="dark-logo">
				<img src="../vendors/mrcet-removebg-preview.png" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="cclmanager.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">ccl leave</span>
						</a>
